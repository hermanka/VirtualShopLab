-- MySQL dump 10.11
--
-- Host: localhost    Database: virtualshop
-- ------------------------------------------------------
...
CREATE USER 'virtualshop'@'%' IDENTIFIED BY 'webvuln!@#';

GRANT USAGE ON * . * TO 'virtualshop'@'%' IDENTIFIED BY 'webvuln!@#' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

GRANT SELECT , INSERT , UPDATE , DELETE , CREATE , DROP , INDEX , ALTER , CREATE TEMPORARY TABLES , CREATE VIEW , SHOW VIEW , CREATE ROUTINE, ALTER ROUTINE, EXECUTE ON `virtualshop` . * TO 'virtualshop'@'%';
...
-- INSERT INTO `coupons` VALUES (1,'SUPERBUY',50, 4);
...
INSERT INTO `pictures` VALUES (10,'Awesome Flower Pic',128,128,'flowers','flowers/flowers',40,'NjE4NDgwOQ==','2009-02-18 14:54:56',2),
(9,'The Boys - In costume',128,128,'toga','toga/togasfs',40,'MTk1NDMxOQ==','2009-02-18 14:54:13',10),
(8,'Me and the Girls',128,128,'toga','toga/togas',40,'MTc3Mjgx','2009-02-18 14:53:48',10),
(7,'My Dog',128,128,'doggie','doggie/Dog.jpg',40,'OTA5MjA1NA==','2009-02-18 14:50:30',1),
(11,'My House!',128,128,'house','house/My_House',40,'ODExNzIzOQ==','2009-02-18 14:55:20',2),
(12,'Beautiful Waterfall',128,128,'waterfall','waterfall/Waterfall',40,'ODQ4OTkx','2009-02-18 14:56:47',1),
(13,'Our House',128,128,'house','house/our_house',40,'OTE4MzM1Mw==','2009-02-18 14:57:18',11),
(14,'The house I share',128,128,'house','house/hodjjgld',40,'MzM4OTU3MA==','2009-02-18 14:57:58',11),
...
INSERT INTO `users` VALUES (1,'Sample User','Sample','User','3e912f8fc814831804d735dc2fcbc3cfa75c28e3','NjM2',20,'2009-01-05 14:29:00','2009-02-18 14:50:00'),
(2,'bob','I Am Bob','Gilbert','abd09072e674720d87ddd27122f67eedbc4b0d08','Mjkx',20,'2009-01-05 14:51:05','2009-02-18 14:54:26'),
(4,'scanner1','Scanner','1','af256af3d4fda990dbe546daa04e5c75eae356ea','ODUy',20,'2009-02-18 14:46:21','2009-02-18 14:46:21'),
(5,'scanner2','Scanner','2','f9335d39b2b78018c2b8affa7fc7b0917a3300a7','MzI5',20,'2009-02-18 14:46:34','2009-02-18 14:46:34'),
(11,'bryce','Bryce','Boe','478fb0b83851b3d16ffc5a2554a4d616f1235156','NjY3',20,'2009-02-18 14:57:36','2009-02-18 14:57:36');
