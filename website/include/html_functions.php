...
<html>
  <head>
    ...
    <title>VirtualShop.com</title>
  </head>
  <body>
    <div class="container " style="border: 2px solid #f39237;">
      <div class="column span-24 first last">
	<h1 id="title"><a href="/">VirtualShop.com</a></h1>
      </div>
      <div id="menu">
	<div class="column prepend-1 span-14 first">
	  <ul class="menu">
	    ...
	    <li class="<?php if($selected == "recent"){ echo 'current'; } ?>"><a href="/pictures/recent.php"><span>Shop</span></a></li>
